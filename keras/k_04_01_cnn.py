...
class CNN(tf.keras.Model):
    def __init__(self, num_classes):
        ...
        self.cnn1 = tf.keras.layers.Conv2D(filters=16, kernel_size=(5, 5), padding='same', strides=(2, 2), kernel_initializer='random_normal')
        self.bn1 = tf.keras.layers.BatchNormalization()

        self.cnn2 = tf.keras.layers.Conv2D(filters=32, kernel_size=(5, 5), padding='same', strides=(2, 2), kernel_initializer='random_normal')
    ...
    def  call(self, inputs, training=None, mask=None):
        ...
        x = tf.keras.activations.relu(self.bn2(self.cnn2(x)))
        x = self.pool(x)
...
if __name__ == '__main__':
    ...
    saver.save('weights/k_04_01_cnn/weights.ckpt')